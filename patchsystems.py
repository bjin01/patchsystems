...
for e in systemlist:
    erratalist = session_client.system.getRelevantErrata(session_key, s)
    print(erratalist)
    for r in erratalist:
        finalpatches.append(r['id'])
        #print(finalpatches)
        #try:
        jobid = session_client.system.scheduleApplyErrata(session_key, s,  r['id'],  earliest_occurrence)
        print(jobid)
        #except:
        #    print()
